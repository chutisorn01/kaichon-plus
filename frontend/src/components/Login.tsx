        ...
        <div className="bg-white/80 dark:bg-slate-900/60 backdrop-blur-xl py-10 px-6 sm:px-8 shadow-2xl rounded-2xl sm:rounded-3xl border border-slate-200 dark:border-white/10 relative overflow-hidden transition-colors duration-500">
          ...
          <form className="space-y-6 relative z-10" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="text-sm flex items-center justify-end w-full">
                <a 
                  href="https://line.me/ti/p/~your_line_id" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="group flex items-center gap-1.5 text-slate-500 hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 transition-all font-medium bg-slate-50 hover:bg-slate-100 dark:bg-slate-800/50 dark:hover:bg-slate-800 px-3 py-1.5 rounded-full border border-slate-200 dark:border-slate-700 shadow-sm hover:shadow"
                  title="ติดต่อแอดมินผ่าน LINE เพื่อรีเซ็ตรหัสผ่าน"
                >
                  <span className="text-[11px] opacity-90">ลืมรหัสผ่าน?</span>
                  <div className="flex items-center gap-1 text-[#00B900] bg-green-50 dark:bg-green-950/30 px-2 py-0.5 rounded-full">
                    <svg className="w-3.5 h-3.5 fill-current drop-shadow-sm transition-transform group-hover:scale-110" viewBox="0 0 24 24">
                    ...
                    <span className="font-bold text-[11px] uppercase tracking-wider">Line</span>
                  </div>
                </a>
              </div>
            </div>
