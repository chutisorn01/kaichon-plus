...
export const translations: Translations = {
  ...
  "home.searchPlaceholder": { th: "ค้นหาชื่อไก่, รหัสกิ๊ฟปีก, หรือพ่อ/แม่พันธุ์...", en: "Search rooster name, wing band code, or parents..." },
  "home.rankingTitle": { th: "พ่อไก่ติดอันดับยอดนิยม", en: "Top Ranking Roosters" },
  "home.featuredStuds": { th: "พ่อพันธุ์แนะนำพิเศษ", en: "Featured Studs" },
  "home.featuredStudsSub": { th: "พ่อพันธุ์ยอดนิยมที่เปิดรับผสมพันธุ์และรับประกันสายเลือดโดยตรง", en: "Popular stud roosters open for breeding and directly guaranteed pedigree" },
