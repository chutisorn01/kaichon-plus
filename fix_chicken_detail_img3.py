...
pattern = re.compile(r'\{chick\.image \? \(\s*<>\s*<img src=\{chick\.image\}.*?\{!isPublic \? \'เพิ่มรูปภาพ\' : \'ไม่มีรูปภาพ\'\}\s*</span>\s*</>\s*\)\}', re.DOTALL)
...
with open(file_path, 'w') as f:
    f.write(content)
print(f"Updated {file_path}, replaced {count} times")
